...
int main() {
    ...
    // 1. Resolve and call add_numbers
    ...
    // Call virtualized add_numbers(20, 30) -> should run under our VM inside libprotected.so and return 50
    ...
    // 2. Resolve and call check_logic
